  ...
  new Vue({
    ...
    methods: {
        ...
        if (this.groupTypeCal === 1 || this.groupTypeCal === 5) {
          ...
          if ((this.groupTypeCal === 2 || this.groupTypeCal === 6) && size > 2) {
            ...
            this.getMediaId(rowData).then((mediaId) => {
              if (this.groupTypeCal === 2 || this.groupTypeCal === 6) {
                // 图片
                params = {
      ...
      getMediaId(rowData) {
        ...
        return new Promise((resolve) => {
          Mt_Util.post('/ajax/wxWork/material/tsMaterial_h.jsp?cmd=getMediaId', params).then(
            (res) => {
    ...
    created() {
      let corpKey = Ts_util.getUrlParam(document.URL, 'corpKey')
        ...
        : ''
      corpKey
        ? Ts_util.navigate('/wxwork/indexCenter.jsp?' + 'corpKey=' + corpKey + '#/chatCenter')
        : Ts_util.navigate('/wxwork/indexCenter.jsp?#/chatCenter')
